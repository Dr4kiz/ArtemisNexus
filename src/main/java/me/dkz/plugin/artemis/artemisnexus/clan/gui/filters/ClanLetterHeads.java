...
public enum ClanLetterHeads {
    ...
    DISABLED("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYzEwNTkxZTY5MDllNmEyODFiMzcxODM2ZTQ2MmQ2N2EyYzc4ZmEwOTUyZTkxMGYzMmI0MWEyNmM0OGMxNzU3YyJ9fX0="),
    HEART("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZTM0ZDBlNTc2NDlmZDY2MTkyZTA3MzE2MDVkYjA5MzBiMTA5ZDgxMjVkOGRlYWQ4YzFlYzBmZTlmN2Y3YWJjYyJ9fX0="),
    DEFAULT("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYmRkMmViMGM2ZjhhOTU0M2VmNWZkNzI1MjVjYzJmYWIzNTY2M2NkNzA5MTM1ZTQzYjhlMjU3ZGMwYjc1ODk0OCJ9fX0=");
    private String texture;

    ClanLetterHeads(String texture) {
    ...
    public static String getTexture(char letter) {
        if (!String.valueOf(letter).matches("[a-zA-Z]")) return ClanLetterHeads.DEFAULT.getTexture();
        return ClanLetterHeads.valueOf(String.valueOf(letter)).getTexture();
    }

    public static String getTexture(String letter) {
        return ClanLetterHeads.valueOf(letter).getTexture();
    }
}